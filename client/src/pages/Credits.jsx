  ...
  return (
    <div className='max=w-7xl h-screen overflow-y-scroll mx-auto px-4 sm:px-6 lg:px-8 py-12'>
      ...
      <div className='flex  justify-center gap-8'>
         {
          plane.map((plan)=>(
            <div key={plan._id} className={`border border-gray-200 dark:border-purple-700 rounded-lg shadow hover:shadow-lg p-6 transition-shadow  min-w-[300px] flex flex-col ${plan._id==='pro'? 'bg-purple-50 dark:bg-purple-900':'bg-white dark:bg-transparent'}`}>
           ...
           <ul className='list-disc list-inside text-sm text-gray-700 dark:text-pink-200 space-y-1'>
